...
function savegen(id,count,st_id)
	...
	function init()
	{
		...
		xmlhttp.open('GET', 'show_table.php?sub_id='+sub_id+'&section='+section+'&exam='+exam+'&session='+session+'&username='+username,true);
		xmlhttp.send();
...
//		<input type='hidden' name='st_name".$j."' value=".$name.">
 ...
 echo "</br></br></br></br></br></br>";
	...
	<table  class='table' id='table1' style='position:relative; left:0;' >
