...
function showsection(sem,dept)
 ...
 <body id="main">
   ...
   <form method="POST" action="subjectwise_show_nba_attempted.php" id="form">
	...
	<table id="table" width="40%">
		<tr>
		<td>Semester:</td>
		<td><select size="1" name="semester" id="semester" required="required" onchange="showsubject(this.value,'<?php echo $dept; ?>');">
