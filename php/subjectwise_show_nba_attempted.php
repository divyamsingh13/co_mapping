...
{
	$fac_id1=$fac_id[$j];
$get_name = "SELECT * FROM login WHERE userid='$fac_id1' ";
...
$name_fac=array_unique($name_fac);
 ...
 ?>
 <body>
 <?php echo "<input type='button' name='print' value='PRINT'  id='print' onclick='printpage();'></input>";?>
 <center><h5><b>AJAY KUMAR GARG ENGINEERING COLLEGE<br>
 					...
 					Faculty : <?php for($j=0;$j<$i;$j++) echo $name_fac[$j]."&nbsp " ;?><br>
 					</b></h5>
...
$select_questions = "SELECT distinct(question),co_no,max_marks FROM questions WHERE semester='$sem' AND sub_id='$sub_id' AND exam='$exam' ORDER BY question ASC";
...
<b><p style='margin-left:0px; margin-top:70px;'><?php for($j=0;$j<$i;$j++)echo $name_fac[$j]."&nbsp &nbsp";?><br>
